...
function baseG() {
  return {
    ...
    items: {
      ...
      blade: { g: 8400, type: "weapon", wtype: "short_sword", upgrade: true, attack: 20, grades: [7, 9, 10, 12] },
      fireblade: { g: 96000, type: "weapon", wtype: "short_sword", upgrade: true, attack: 21, grades: [0, 8, 10, 12] },
      sshield: { g: 24000, type: "shield", upgrade: true, armor: 60, resistance: 20, dreturn: 3, grades: [4, 8, 10, 12] },
      staff: { g: 12400, type: "weapon", wtype: "staff", upgrade: true, attack: 20, grades: [7, 9, 10, 12] },
      essenceoffire: { g: 40000, type: "material", s: 9999 },
      ...
      shield: { g: 24000, type: "shield", upgrade: true, armor: 60, resistance: 20, grades: [4, 8, 10, 12] },
      lotusf: { g: 12000 },
      snakefang: { g: 1200 }
    },
    craft: {
