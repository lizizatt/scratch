...
function baseG() {
  return {
    ...
    items: {
      ...
      gift0: { g: 2400, e: 1, type: "gem" },
      anniversarygift: { g: 0, e: 1, type: "misc" },
      armorbox: { g: 120000, e: 1, type: "box" },
      weaponbox: { g: 320000, e: 1, type: "box" },
      jewellerybox: { g: 80000, e: 1, type: "box" },
      apologybox: { g: 120000, e: 1, type: "box" },
      bugbountybox: { g: 120000, e: 1, type: "box" },
      mysterybox: { g: 12000000, e: 1, type: "misc" },
      xbox: { g: 1000000, e: 1, type: "quest" },
      ...
      dagger: { g: 167000, type: "weapon", wtype: "dagger", upgrade: { attack: 4 }, grades: [0, 7, 10, 12] },
      t2bow: { g: 78000, type: "weapon", wtype: "bow", upgrade: { attack: 6 }, grades: [0, 7, 10, 12] },
      coat1: { g: 48000, set: "rugged", type: "chest", stat: 2, armor: 24, resistance: 16, upgrade: { stat: 1, armor: 2.5, resistance: 2.5 }, grades: [0, 7, 10, 12] },
      gloves1: { g: 34000, set: "rugged", type: "gloves", stat: 2, armor: 16, resistance: 8, upgrade: { stat: 1, armor: 2.5, resistance: 2.5 }, grades: [0, 7, 10, 12] },
      helmet1: { g: 32000, set: "rugged", type: "helmet", stat: 2, armor: 14, resistance: 16, upgrade: { stat: 1, armor: 2.5, resistance: 2.5 }, grades: [0, 7, 10, 12] },
      pants1: { g: 78000, set: "rugged", type: "pants", stat: 2, armor: 20, resistance: 12, upgrade: { stat: 1, armor: 2.5, resistance: 2.5 }, grades: [0, 7, 10, 12] },
      shoes1: { g: 120000, set: "rugged", type: "shoes", stat: 2, armor: 8, speed: 6, upgrade: { stat: 1, armor: 2.5, speed: 0.875 }, grades: [0, 7, 10, 12] },
      ...
      mmhat: { g: 64000, class: ["mage"], set: "mmage", type: "helmet", stat: 2, armor: 19, resistance: 22, rpiercing: 40, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mmgloves: { g: 68000, class: ["mage"], set: "mmage", type: "gloves", stat: 2, armor: 22, resistance: 11, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mmpants: { g: 128000, class: ["mage"], set: "mmage", type: "pants", stat: 2, armor: 28, resistance: 17, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mmarmor: { g: 96000, class: ["mage"], set: "mmage", type: "chest", stat: 2, armor: 33, resistance: 22, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mmshoes: { g: 240000, class: ["mage"], set: "mmage", type: "shoes", stat: 2, armor: 11, resistance: 5, speed: 6, upgrade: { stat: 1, speed: 0.90625, armor: 4, resistance: 2 }, grades: [0, 7] },
      mpgloves: { g: 68000, class: ["priest"], set: "mpriest", type: "gloves", stat: 2, armor: 22, resistance: 11, output: 5, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mphat: { g: 64000, class: ["priest"], set: "mpriest", type: "helmet", stat: 2, armor: 19, resistance: 22, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mppants: { g: 128000, class: ["priest"], set: "mpriest", type: "pants", stat: 2, armor: 28, resistance: 17, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mparmor: { g: 96000, class: ["priest"], set: "mpriest", type: "chest", stat: 2, armor: 33, resistance: 22, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 7] },
      mpshoes: { g: 240000, class: ["priest"], set: "mpriest", type: "shoes", stat: 2, armor: 11, resistance: 5, speed: 6, upgrade: { stat: 1, speed: 0.90625, armor: 4, resistance: 2 }, grades: [0, 7] },
      mwgloves: { g: 68000, class: ["warrior"], set: "mwarrior", type: "gloves", stat: 2, armor: 23, resistance: 12, crit: 1, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 5] },
      mwhelmet: { g: 64000, class: ["warrior"], set: "mwarrior", type: "helmet", stat: 2, armor: 21, resistance: 23, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 5] },
      mwarmor: { g: 96000, class: ["warrior"], set: "mwarrior", type: "chest", stat: 2, armor: 35, resistance: 23, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 5] },
      mwpants: { g: 128000, class: ["warrior"], set: "mwarrior", type: "pants", stat: 2, armor: 29, resistance: 18, upgrade: { stat: 1, armor: 4, resistance: 4 }, grades: [0, 5] },
      mwboots: { g: 240000, class: ["warrior"], set: "mwarrior", type: "shoes", stat: 2, armor: 12, resistance: 6, speed: 7, upgrade: { stat: 1, speed: 1.03125, armor: 4, resistance: 2 }, grades: [0, 5] },
    },
    tokens: {
      monstertoken: {
        mmhat: 7,
    ...
    sets: {
      rugged: { 2: { str: 1, dex: 1, int: 1 }, 3: { armor: 20, resistance: 20, range: 2 }, 4: { for: 8 }, 5: { speed: 4, phresistance: 25, stresistance: 20 } },
      mmage: { 2: { int: 2 }, 3: { speed: 2, int: 3 }, 4: { rpiercing: 40 }, 5: { crit: 2 } },
      mpriest: { 2: { int: 3 }, 3: { speed: 2, int: 3 }, 4: { rpiercing: 120 }, 5: { mp: 2000, crit: 2 } },
      mwarrior: { 2: { str: 2 }, 3: { speed: 1, str: 3 }, 4: { apiercing: 40 }, 5: { crit: 5 } },
    },
    craft: {
      orbg: {
    ...
    skills: {
      charge: { class: ["warrior"], mp: 0, cooldown: 40000, duration: 3200, condition: "charging" },
      taunt: { class: ["warrior"], mp: 40, cooldown: 3000, range: 200 },
      hardshell: { class: ["warrior"], level: 60, mp: 480, cooldown: 16000, duration: 8000, condition: "hardshell" },
      cleave: { mp: 720, cooldown: 1200, level: 52 },
      reflection: { class: ["mage"], level: 60, mp: 540, cooldown: 30000, duration: 5000, condition: "reflection", range: 320 },
      energize: { class: ["mage"], level: 20, cooldown: 4000, duration: 800, condition: "energized", range: 320 },
      curse: { class: ["priest"], mp: 400, cooldown: 5000, duration: 5000, condition: "cursed", range: 200 },
      absorb: { class: ["priest"], level: 55, mp: 200, cooldown: 400, range: 240 },
      partyheal: { mp: 400, cooldown: 200 },
      revive: { mp: 500, cooldown: 200, range: 240 },
