...
function baseG() {
  return {
    ...
    items: {
      ...
      mmarmor: { class: ["mage"], set: "mmage", type: "chest", stat: 2, armor: 33, resistance: 22, grades: [0, 7] },
      mmshoes: { class: ["mage"], set: "mmage", type: "shoes", stat: 2, armor: 11, resistance: 5, speed: 6, grades: [0, 7] },
      ...
      mparmor: { class: ["priest"], set: "mpriest", type: "chest", stat: 2, armor: 33, resistance: 22, grades: [0, 7] },
      mpshoes: { class: ["priest"], set: "mpriest", type: "shoes", stat: 2, armor: 11, resistance: 5, speed: 6, grades: [0, 7] },
      mwgloves: { class: ["warrior"], set: "mwarrior", type: "gloves", stat: 2, armor: 23, resistance: 12, crit: 1, grades: [0, 5] },
      mwhelmet: { class: ["warrior"], set: "mwarrior", type: "helmet", stat: 2, armor: 21, resistance: 23, grades: [0, 5] },
      mwarmor: { class: ["warrior"], set: "mwarrior", type: "chest", stat: 2, armor: 35, resistance: 23, grades: [0, 5] },
      mwpants: { class: ["warrior"], set: "mwarrior", type: "pants", stat: 2, armor: 29, resistance: 18, grades: [0, 5] },
      mwboots: { class: ["warrior"], set: "mwarrior", type: "shoes", stat: 2, armor: 12, resistance: 6, speed: 7, grades: [0, 5] },
    },
    tokens: {
      monstertoken: {
        mmhat: 7,
