...
export class CombatTestSim {
  ...
  snapshot(): RunSnapshot {
    return {
      ...
      enemyKind: "boss",
      enemyVisual: "chasmfiend",
      enemyProgress: this.encounter.enemy.cooldown.progress,
      enemyScreenX: tuning.SCREEN_WIDTH_PX * 0.5 + tuning.COMBAT_TIP_REACH / 2,
      corpseVisual: null,
      corpseScreenX: null,
      enemyFallT: 0,
      clawScreenX: null,
      ...
      fleeScreenX: null,
      showBarracks: false,
      barracksScreenX: null,
      guardScreenOffsetX: 180,
      fadeAlpha: 0,
      epilogueText: null,
      sceneId: "chasm",
      tauntLine: null,
